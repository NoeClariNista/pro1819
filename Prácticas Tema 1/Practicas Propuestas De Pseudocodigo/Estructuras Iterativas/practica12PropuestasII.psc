// 12. Haz un algoritmo que pida el valor de dos enteros n y m y que muestre por
// pantalla el valor del sumatorio desde i=n hasta m de i2.

Algoritmo practica12PropuestasII
	...
	Para i <- n Hasta m Con Paso 1 Hacer // Realiza un bucle para realizar la operación.
		acumulador <- i*i + acumulador; // Vamos guardando el valor del acumulador.
	FinPara
